...
public class CustomerService {
    ...
    public void updateCustomer(@Valid CustomerRequest request) {
        ...
        mergedCustomer(customer, request); //certify that no existing value can be override with null
        repository.save(customer);
    }

    private void mergedCustomer(Customer customer, @Valid CustomerRequest request) {
